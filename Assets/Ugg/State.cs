...
public class Patrol : State
{
    ...
    public override void Enter()
    {
        ...
        for (int i = 0; i < UggGameEnvironment.Singleton.Checkpoints.Count; i++)
        {
            GameObject thisWP = UggGameEnvironment.Singleton.Checkpoints[i];
    ...
    public override void Update()
    {
        ...
        {
            if (currentIndex >= UggGameEnvironment.Singleton.Checkpoints.Count - 1)
            {
                currentIndex = 0;
            }
            else
